  ...
  return _c("card", { staticClass: "flex flex-col " }, [
    _c("div", { staticClass: "px-3 py-3" }, [
      _c("h1", { staticClass: "text-center text-3xl text-80 font-light" }, [
        _vm._v("Card de Analitys de prueba")
      ]),
      _vm._v(" "),
      _c("h2", { staticClass: "text-center text-3xl text-80 font-light" }, [
        _vm._v("Links hacia ropa")
      ]),
      _vm._v(" "),
      _c(
        "a",
        { staticClass: "links", attrs: { href: "/nova/resources/ropas" } },
        [_vm._v("Ver Ropa")]
      ),
      _vm._v(" "),
      _c(
        "a",
        { staticClass: "links", attrs: { href: "/nova/resources/ropas/new" } },
        [_vm._v("Agregar nueva ropa")]
      )
    ])
  ])
}
